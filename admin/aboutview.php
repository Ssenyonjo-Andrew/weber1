										...
										<table class="table table-stripped table-bordered table-hover">
											...
											<tbody>
												<tr>
													...
													<td><a href="aboutedit.php?id=<?php echo $row['0']; ?>"><button class="btn btn-info" style=' border-radius:20px'>Edit</button></a>
													<a href="aboutdelete.php?id=<?php echo $row['0']; ?>"><button class="btn" style=' border-radius:20px; background-color:orange'>Delete</button></a></td>
												</tr>
											</tbody>
												<?php
												$cnt=$cnt+1;
