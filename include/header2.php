<header id="header" class="transparent-header-modern fixed-header-bg-transparent w-100"  >
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2" style="background: rgba(0,0,0,0.1); backdrop-filter: blur(10px);" >
                <div class="container" >
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0" > <a class="navbar-brand position-relative" href="index2.php"><img class="nav-logo" src="images/logo/restatelg_white.jpg" height=100 width=200 alt=""></a>
