                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">Shs<?php echo $row['6'];?> <span class="text-white"><?php echo $row['5'];?>(size)</span></div>
                                        
                                    </div>
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="propertydetail2.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
                                ...
                                <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                    <h6 class=" hover-text-success text-capitalize"><a href="propertydetail2.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h6>
